...
CREATE DATABASE [DS2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'primary', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\ds.mdf' , SIZE = 9280KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
 FILEGROUP [DS_CUST_FG] 
( NAME = N'cust1', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\cust1.ndf' , SIZE = 614400KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
( NAME = N'cust2', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\cust2.ndf' , SIZE = 614400KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
 FILEGROUP [DS_IND_FG] 
( NAME = N'ind1', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\ind1.ndf' , SIZE = 153600KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
( NAME = N'ind2', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\ind2.ndf' , SIZE = 153600KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
 FILEGROUP [DS_MISC_FG] 
( NAME = N'ds_misc', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\ds_misc.ndf' , SIZE = 204800KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
 FILEGROUP [DS_ORDERS_FG] 
( NAME = N'orders1', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\orders1.ndf' , SIZE = 307200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB ), 
( NAME = N'orders2', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\orders2.ndf' , SIZE = 307200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ds_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50MSSQLSERVER\MSSQL\DATA\ds_log.ldf' , SIZE = 1024000KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
